...
기존 PR 의 description 을 *실제 변경사항*에 맞게 갱신한다. PR body / title 형식은 `pr-create` 스킬을 *유일한 source* 로 한다 — 이 파일은 *분석·갱신 절차*만 담는다. 변경 작업 자체는 AGENTS.md 의 Surgical Changes 를 따른다.

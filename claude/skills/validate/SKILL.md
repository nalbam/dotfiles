...
저장소의 lint·타입 검사·테스트를 실행하고 승인된 범위의 실패 원인을 수정한다. 변경은 `skills/coding-style/SKILL.md#surgical-changes--외과적-변경`, 실패 분류는 `skills/testing-rules/SKILL.md#failure-triage--실패-분류`를 따른다.
